...
export const projects: Project[] = [
  {
    ...
    brdReceivingDate: "2026-01-10",
    projectTypeId: "pt-internal",
    startDate: "2026-01-15",
    endDate: "2026-06-30",
    categoryId: "cat-software",
    initiatedById: "init-dept-a",
    departmentalPocId: "user-dev",
    partnerIds: ["user-dev2"],
    projectStatusId: "ps-active",
    projectManagerId: "user-admin",
    priorityId: "pri-high",
    projectAction: "assigned",
    assignToId: "user-admin",
    taskTemplateId: "tpl-software",
    isDraft: false,
  },
  {
    id: "proj-2",
  ...
  },
  {
    ...
    endDate: "2026-12-31",
    projectTypeId: "pt-rnd",
    categoryId: "cat-process",
    projectStatusId: "ps-hold",
    priorityId: "pri-low",
    projectAction: "hold",
    projectManagerId: "user-admin",
    isDraft: false,
  ...
  "sprint-1a": [
    {
      ...
      tasks: [
        createProjectTask("t-1", "proj-1", "sprint-1a", "sprint-1a-col-todo", "JWT refresh flow", "todo", 0, ["user-dev", "user-dev2"], ["Dana Developer", "Sam Smith"], 3, {
          subtasks: [
            { id: "st-1-1", title: "Task A", description: "Review token expiry handling in the auth middleware.", order: 0, linkedTaskId: null, assigneeIds: [], assigneeNames: [], completed: true, subtasks: [
              { id: "st-1-1-1", title: "Inspect middleware chain", description: "Trace refresh token path through existing middleware.", order: 0, linkedTaskId: null, assigneeIds: [], assigneeNames: [], completed: true, subtasks: [] },
              { id: "st-1-1-2", title: "Validate expiry edge cases", description: "Cover clock skew and near-expiry tokens.", order: 1, linkedTaskId: null, assigneeIds: [], assigneeNames: [], completed: false, subtasks: [
                { id: "st-1-1-2-1", title: "Add skew tolerance test", description: "Simulate ±30s client clock drift.", order: 0, linkedTaskId: null, assigneeIds: [], assigneeNames: [], completed: false, subtasks: [] },
              ] },
            ] },
            { id: "st-1-2", title: "Task B", description: "Coordinate with Role guard work — shared session edge cases.", order: 1, linkedTaskId: "st-2-4", assigneeIds: ["user-dev2"], assigneeNames: ["Sam Smith"], completed: false, subtasks: [] },
            { id: "st-1-3", title: "Task C", description: "Add integration tests for refresh rotation.", order: 2, linkedTaskId: null, assigneeIds: [], assigneeNames: [], completed: false, subtasks: [] },
          ],
        }),
        createProjectTask("t-2", "proj-1", "sprint-1a", "sprint-1a-col-todo", "Role guard components", "todo", 1, ["user-dev2"], ["Sam Smith"], 2, {
          subtasks: [
            { id: "st-2-1", title: "Audit routes", description: "List all protected routes and current guard coverage.", order: 0, linkedTaskId: null, assigneeIds: [], assigneeNames: [], completed: false, subtasks: [] },
            { id: "st-2-2", title: "Map roles", description: "Document admin vs developer permissions matrix.", order: 1, linkedTaskId: null, assigneeIds: [], assigneeNames: [], completed: false, subtasks: [] },
            { id: "st-2-3", title: "Write guards", description: "Implement route-level guard components.", order: 2, linkedTaskId: null, assigneeIds: [], assigneeNames: [], completed: false, subtasks: [] },
            { id: "st-2-4", title: "Task F", description: "Final verification pass for cross-task dependencies.", order: 3, linkedTaskId: null, assigneeIds: [], assigneeNames: [], completed: false, subtasks: [] },
          ],
        }),
      ],
    },
    {
      ...
      tasks: [
        createProjectTask("t-3", "proj-1", "sprint-1a", "sprint-1a-col-progress", "Login page UI", "in_progress", 0, ["user-dev", "user-dev2"], ["Dana Developer", "Sam Smith"], 5),
      ],
    },
    {
